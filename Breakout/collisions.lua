...
local bounce_off_wall_sound = love.audio.newSource("sounds/ballwall.ogg",static)
local bounce_off_paddle_sound = love.audio.newSource("sounds/bonus1.wav", static)
